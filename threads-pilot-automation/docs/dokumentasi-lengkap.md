...
- **Dokumen pitching** (`pitch-automation-threads.docx`) — versi ringkas non-teknis untuk presentasi.
- **Panduan pengguna** (`panduan-pengguna-threads.docx`) — panduan penggunaan harian (approve/edit/reject) untuk pengguna baru.
